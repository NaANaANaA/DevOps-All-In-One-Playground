...
The Kubernetes starter allows namespace-local ingress by default and allows only DNS plus common HTTP/HTTPS egress by default. Tighten `networkpolicy.yaml` to your destination CIDRs or service namespaces before production use.
